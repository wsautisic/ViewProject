...
//        // 该段落是图片占位符
////        per.qiao.utils.hutool.poi.ImageEntity imageEntity = (per.qiao.utils.hutool.poi.ImageEntity) PoiWordUtils.getValueByPlaceholder(paramMap, text);
...
//   */
//  private void addPicture(XWPFRun currRun, per.qiao.utils.hutool.poi.ImageEntity imageEntity) throws InvalidFormatException, FileNotFoundException {
